...
public class EchoServerScene : IScene
{
    ...
    public EchoServerScene()
    {
        SceneName = "EchoServerScene";
    }
    ...
    void Awake()
    {
        ...
        MNF_EchoServer.Instance.EchoServerScenePoint = this;
        ...
        if (IPPulse.Instance.Start(getPrivateIPList, "999", true) == false)
            Debug.Log("LogWriter start failed");
